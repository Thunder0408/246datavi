...
chart6 = alt.Chart(grouped_6).mark_bar().encode(
    y=alt.Y('sum(จำนวนนักศึกษา):Q', title='จำนวนนักศึกษา (คน)'),
    x=alt.X('คุณเป็นนักศึกษาชั้นปีที่:N', title='ชั้นปี'),
...
chart8 = alt.Chart(df).mark_bar().encode(
    x=alt.X('คุณใช้จ่ายในส่วนนี้ไปประมาณเท่าไหร่ต่อเดือน ?:N', title='ค่าใช้จ่ายโดยประมาณต่อหนึ่งเดือน'),
    y=alt.Y('จำนวนนักศึกษา:Q', title='จำนวนนักศึกษา (คน)'),
